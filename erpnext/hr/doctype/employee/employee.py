...
def send_birthday_reminders():
	...
	companies_with_birthdays = set(employee['company'] for employee in employees)
	...
	if employees:
		...
		for employee in employees:
			recipients = [{'name': recipient['name']} for recipient in recipients_list if recipient['company'] == employee.company ]
